...
Vagrant.configure(2) do |config|
  ...
  config.vm.provision 'docker_install', type: :ansible_local do |ansible|
#    ansible.galaxy_role_file = '/vagrant/requirements.yml'
#   ansible.galaxy_roles_path = '/etc/ansible/roles'
#    ansible.galaxy_command = 'ansible-galaxy install %{role_file}'
    ansible.playbook = 'plays/install_docker.yml' 
  end

  config.vm.provision 'create_containers', run: 'always', type: :ansible_local do |ansible|
    ansible.playbook = 'plays/create_container.yml'
  end
